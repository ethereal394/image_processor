...
Консольное приложение, которое позволяет применять фильтры для изображений в формате 24-битного BMP без сжатия и без таблицы цветов.
...
#### Compress (-compress width height)
Сжимает изображение изображение до заданных ширины и высоты.

Если запрошенные ширина или высота превышают размеры исходного изображения, выдается доступная часть изображения.

#### Compress (-compress coefficient)
Сжимает изображение изображение с заданным коэффициентом.
